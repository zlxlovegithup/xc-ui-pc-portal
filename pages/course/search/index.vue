  ...
  export default {
    ...
    methods:{
      ...
      handleSizeChange(size) {
        ...
        this.page_size = size;
        this.$route.query.page_size = size;
        let querys = querystring.stringify(this.$route.query); //将this.$route.query转换为key-value串设置进入路由中
